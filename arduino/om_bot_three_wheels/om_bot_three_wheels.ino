...
double flKp = 0.43, flKi = 1.4, flKd = 0.001;
double frKp = 0.43, frKi = 1.4, frKd = 0.001;
double rrKp = 0.43, rrKi = 1.4, rrKd = 0.001;
double rlKp = 0.43, rlKi = 1.4, rlKd = 0.001;
//Declaring the PID
...
kinematics_arduino3 kinematics(&vx, &vy, &vth, &FLsetpoint, &FRsetpoint, &RRsetpoint, &RLsetpoint, &linearscale, &angularscale);
